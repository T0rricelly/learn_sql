...
VALUES(1, "CC"),(2,"CE"),(3,"TI");
INSERT INTO tipo_documento (TIPO_DOCUMENTO)
VALUES("pAS");
Update Tipo_documento set tipo_documento = "PP" 
WHERE tipo_documento = "pAS";
...
INSERT INTO factura (cantidad,total,Servicioid,Productoid,Clienteid,Empleadoid)
